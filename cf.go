...
import (
	...
	// "github.com/shumengliu/cf-tool/client"
	"github.com/shumengliu/cf-tool/client"
	"github.com/shumengliu/cf-tool/cmd"
	"github.com/shumengliu/cf-tool/config"
...
func main() {
	usage := `Codeforces Tool $%version%$ (cf). https://github.com/shumengliu/cf-tool
